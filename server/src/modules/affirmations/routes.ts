...
export async function affirmationRoutes(app: FastifyInstance) {
  // Get all categories
  ...
  app.get('/categories/:categoryId', { preHandler: [optionalAuth] }, async (request) => {
  ...
  app.get('/daily', { preHandler: [optionalAuth] }, async (request) => {
  ...
  app.get('/random', { preHandler: [optionalAuth] }, async (request) => {
  ...
  app.get('/:id', { preHandler: [optionalAuth] }, async (request) => {
  ...
  app.post('/:id/view', { preHandler: [optionalAuth] }, async (request, reply) => {
    const { id } = request.params as { id: string };
